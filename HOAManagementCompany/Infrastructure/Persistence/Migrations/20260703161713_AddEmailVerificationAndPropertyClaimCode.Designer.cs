...
namespace HOAManagementCompany.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260703161713_AddEmailVerificationAndPropertyClaimCode")]
    partial class AddEmailVerificationAndPropertyClaimCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HOAManagementCompany.Domain.Entities.EmailVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HOAManagementCompany.Domain.Entities.PropertyClaimCode", b =>
                {
                    ...
                    b.Property<string>("DeliveredToContact")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.HasIndex("PropertyId")
                        .IsUnique()
                        .HasFilter("\"RedeemedAt\" IS NULL");

                    b.ToTable("PropertyClaimCodes");
                });
