...
public record OwnerDto(Guid Id, string FirstName, string LastName, string? OwnerName2, string Email, string? Phone, bool MailingToProperty, string? MailingAddress, bool PaperlessStatements, bool SmsReminders, bool VotingRights, string AccountNumber, string CommunityName, string PropertyAddress, string? MemberSince);
